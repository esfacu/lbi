# Generated by Django 4.2.6 on 2023-11-29 15:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('location', '0005_alter_lbi_number'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Tienda', models.CharField(choices=[('Dmart5', '"UY_5_Ciudad de la Costa"'), ('Dmart12', '"UY_12_Aguada"'), ('Dmart7', '"UY_7_Sayago"'), ('Dmart4', '"UY_4_Centro"'), ('Dmart9', '"UY_9_La Blanqueada"'), ('Dmart10', '"UY_10_Carrasco Norte"'), ('Dmart11', '"UY_11_Brazo Oriental"'), ('Dmart6', '"UY_6_Maldonado"'), ('Dmart8', '"UY_8_Malvin Norte"'), ('Dmart13', '"UY_13_Tres Cruces"')], max_length=10)),
